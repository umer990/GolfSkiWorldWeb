...
var LocationService = (function () {
    ...
    LocationService.prototype.getAllResorts = function () {
    ...
    LocationService.prototype.aggreateCoordinates = function (coordinatesToBeMapped) {
        ...
        coordinatesToBeMapped.map(function (a) {
            ...
            for (var country_id in country) {
                ...
                coordinatesList.push(new Coordinates_1.Coordinates(coorCountry["lat"], coorCountry["lng"], coorCountry["zoomMin"], coorCountry["zoomMax"], coorCountry["count"], coorCountry["country"], coorCountry["city"], coorCountry["type"], null));
            }
            for (var city_id in city) {
                var coor_2 = city[city_id];
                coordinatesList.push(new Coordinates_1.Coordinates(coor_2["lat"], coor_2["lng"], coor_2["zoomMin"], coor_2["zoomMax"], coor_2["count"], coor_2["country"], coor_2["city"], coor_2["type"], null));
            }
    ...
    LocationService.prototype.MapToCoordinates = function (res) {
        ...
        resorts.map(function (a) {
            ...
            var infoWindow = new InfoWindow_1.InfoWindow(a.phone, address, a.description, " ", [], false, a.name, a.thumbnail);
            var coordinates = new Coordinates_1.Coordinates(lat, lng, 9, 20, "1", countryName, cityName, "", infoWindow);
        ...
        for (var country_id in country) {
            ...
            coordinatesList.push(new Coordinates_1.Coordinates(coor["lat"], coor["lng"], coor["zoomMin"], coor["zoomMax"], coor["count"], coor["country"], coor["city"], coor["type"], null));
        }
        for (var city_id in city) {
